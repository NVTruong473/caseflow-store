...
This app was scaffolded with Next.js `16.2.10`. APIs, conventions, and file structure may differ from older Next.js versions. Before changing Next.js-specific code, check relevant local docs under `node_modules/next/dist/docs/` and heed deprecation notices.
