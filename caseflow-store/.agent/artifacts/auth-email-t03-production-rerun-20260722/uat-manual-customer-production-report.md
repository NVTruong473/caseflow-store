...
- Generated at: 2026-07-22T02:10:50.685Z
- Base URL: https://caseflow-store.vercel.app
- Result: PASS

## Customer Account

- Email: `truongskull014+caseflow-uat-t03-202607220920@gmail.com`
- Name: CaseFlow UAT Customer
- Password: not stored in repository artifacts.

## Order

- Order code: `CF-MRVG3NW6-E8900B93F9`
...
- `.agent/artifacts/auth-email-t03-production-rerun-20260722/01-account-created.png`
- `.agent/artifacts/auth-email-t03-production-rerun-20260722/02-profile-complete.png`
- `.agent/artifacts/auth-email-t03-production-rerun-20260722/03-book-added-to-cart.png`
- `.agent/artifacts/auth-email-t03-production-rerun-20260722/03b-checkout-review-before-submit.png`
- `.agent/artifacts/auth-email-t03-production-rerun-20260722/04-checkout-success.png`
- `.agent/artifacts/auth-email-t03-production-rerun-20260722/05-qr-boundary-orders-redirect.png`
- `.agent/artifacts/auth-email-t03-production-rerun-20260722/06-order-history.png`
