...
| Checkout experience QA | Official checkout remains default; the expiring HTTPS-fragment QR flow uses server totals, separate confirmation code, bounded attempts, polling, and no order/payment/inventory/voucher mutation |
