...
- For detailed post-`v1.6.0` humanized UI rules, use
  `docs/style-guide.md` and `docs/ui-humanization-audit.md` as the current
  storefront design reference. The signature motif is the reading table and
  spine rail, not generic SaaS gradients, fake metrics, or repeated feature
  cards.
